    ...
    <section class="pb-16 pt-10">
      <div class="container mx-auto">
        ...
        <div class="mt-12 grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-3">
          <div className="hover:rounded-2xl p-10 hover:bg-white hover:shadow-xl duration-200 hover:-translate-y-4">
            <div class="flex items-center justify-center h-12 w-12 rounded-md bg-blue-900 text-white">
              <svg
